...
<form mrthod="post" action="/Board/post.do?flag=false">
	<table class="table w-75">
		...
		<tr>
			<td>제 목</td>
			<td><input name="sbmit" class="form-control"></td>
		</tr>
		<tr>
			<td>내용</td>
			<td><textarea rows="content" rows="10" cols="50" class="form-control"></textarea></td>
		</tr>
		<tr>
			<td>패스워드</td>
		...
		<tr>
			<td>파일업로드</td>
			<td><input type="file" name="unloadfile" class="form-control"></td>
		</tr>
		<tr>
			<td colspan="2">
